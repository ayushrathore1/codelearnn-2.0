...
export const useCareerJourney = () => {
  ...
  if (!context) {
    throw new Error('useCareerJourney must be used within CareerJourneyProvider');
  }
  return context;
};
...
export const CareerJourneyProvider = ({ children }) => {
            ...
            if (response.data?.success && response.data?.data) {
              ...
              setJourney({
                ...
                currentPhase: {
                  ...
                  progress: backendJourney.roadmap?.phases?.find(
                    p => p.phaseId === backendJourney.roadmap?.currentPhaseId
                  )?.progress || 0
                }
              });
              // Also sync to localStorage for offline access
              localStorage.setItem(JOURNEY_STORAGE_KEY, JSON.stringify(backendJourney));
              return;
            }
          } catch (apiError) {
  ...
  const updateProgress = (phaseId, resourceId, progressData) => {
    if (!journey) return;
    ...
    setJourney(prev => {
      ...
      if (phase) {
        const resource = phase.resources.find(r => r.resourceId === resourceId);
        if (resource && !resource.isCompleted) {
          ...
          updated.stats.overallProgress = Math.round(totalProgress / allPhases.length);
          ...
          if (phase.progress >= 100 && phase.status !== 'completed') {
            ...
            // Unlock next phase
            const currentIdx = allPhases.findIndex(p => p.phaseId === phaseId);
  ...
  const getNextActions = () => {
    ...
    const pendingProjects = (currentPhase.projects || [])
      .filter(p => !p.isStarted && currentPhase.progress >= 50);
  ...
  const phases = [
    {
      ...
      resources: [
        { resourceId: 'r1-1', type: 'video', title: 'Introduction to Programming', duration: 120, isCompleted: false },
        { resourceId: 'r1-2', type: 'video', title: 'Git & GitHub Essentials', duration: 90, isCompleted: false },
        { resourceId: 'r1-3', type: 'article', title: 'Development Environment Setup', duration: 30, isCompleted: false },
        { resourceId: 'r1-4', type: 'quiz', title: 'Fundamentals Assessment', duration: 20, isCompleted: false },
      ],
      projects: [
        { projectId: 'p1-1', title: 'Setup Development Portfolio', isStarted: false, isCompleted: false },
      ],
      milestones: [
    ...
    },
    {
      ...
      resources: [
        { resourceId: 'r2-1', type: 'course', title: 'Core Technology Deep Dive', duration: 300, isCompleted: false },
        { resourceId: 'r2-2', type: 'video', title: 'Data Structures Explained', duration: 180, isCompleted: false },
        { resourceId: 'r2-3', type: 'practice', title: 'Coding Challenges Set 1', duration: 120, isCompleted: false },
        { resourceId: 'r2-4', type: 'quiz', title: 'Technical Skills Assessment', duration: 30, isCompleted: false },
      ],
      projects: [
        { projectId: 'p2-1', title: 'Build Your First Application', isStarted: false, isCompleted: false },
      ],
      milestones: [
    ...
    },
    {
      ...
      resources: [
        { resourceId: 'r3-1', type: 'course', title: 'Popular Frameworks', duration: 360, isCompleted: false },
      ...
      projects: [
        { projectId: 'p3-1', title: 'Full-Featured Application', isStarted: false, isCompleted: false },
      ],
      durationWeeks: 5,
    },
    {
      ...
      resources: [
        { resourceId: 'r4-1', type: 'course', title: 'System Design Principles', duration: 240, isCompleted: false },
        { resourceId: 'r4-2', type: 'video', title: 'Testing Best Practices', duration: 120, isCompleted: false },
        { resourceId: 'r4-3', type: 'article', title: 'Security Essentials', duration: 60, isCompleted: false },
      ],
      projects: [
        { projectId: 'p4-1', title: 'Production-Ready Project', isStarted: false, isCompleted: false },
      ],
      durationWeeks: 5,
    },
    {
      ...
      resources: [
        { resourceId: 'r5-1', type: 'guide', title: 'Portfolio Building Guide', duration: 60, isCompleted: false },
        { resourceId: 'r5-2', type: 'course', title: 'Interview Preparation', duration: 180, isCompleted: false },
        { resourceId: 'r5-3', type: 'practice', title: 'Mock Interviews', duration: 120, isCompleted: false },
      ],
      projects: [
        { projectId: 'p5-1', title: 'Capstone Project', isStarted: false, isCompleted: false },
      ],
      milestones: [
