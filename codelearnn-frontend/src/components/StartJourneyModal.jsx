...
const StartJourneyModal = ({ isOpen, onClose, career }) => {
  ...
  const weeklyHoursOptions = [
    { value: 5, label: '5 hrs/week', description: 'Casual pace', estimatedWeeks: 40 },
    { value: 10, label: '10 hrs/week', description: 'Recommended', estimatedWeeks: 20 },
    { value: 15, label: '15 hrs/week', description: 'Intensive', estimatedWeeks: 14 },
    { value: 20, label: '20+ hrs/week', description: 'Full-time learner', estimatedWeeks: 10 },
  ];
  
  const experienceLevels = [
    { value: 'beginner', label: 'Complete Beginner', description: 'New to programming' },
    { value: 'some_experience', label: 'Some Experience', description: '1-6 months of coding' },
    { value: 'intermediate', label: 'Intermediate', description: '6+ months, know basics' },
  ];
  ...
  const selectedHoursOption = weeklyHoursOptions.find(o => o.value === preferences.weeklyHours);
        ...
        >
            ...
            <>
              <div className="p-6 border-b border-border">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h2 className="text-xl font-bold text-text-main">Start Your Journey?</h2>
                      <p className="text-sm text-text-muted">{career?.name || career?.title}</p>
                    </div>
                  </div>
                  <button 
                    onClick={handleClose}
              ...
              <div className="p-6">
                ...
                {hasActiveJourney() && (
                  <div className="mb-6 p-4 bg-yellow-500/10 border border-yellow-500/30 rounded-lg">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-yellow-400">You have an active journey</p>
                        <p className="text-xs text-yellow-400/80 mt-1">
                          You're currently working on {journey?.career?.title}. Starting a new journey will pause your current progress.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <p className="text-text-muted mb-6">
                  This will create your personalized learning roadmap for becoming a {career?.name || career?.title}.
                </p>
                ...
                <div className="space-y-4 mb-6">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-text-main">Personalized roadmap</p>
                      <p className="text-xs text-text-muted">Generated based on your skill level and goals</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-text-main">Progress tracking</p>
                      <p className="text-xs text-text-muted">Track every video, article, and project</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-text-main">Weekly recommendations</p>
                      <p className="text-xs text-text-muted">Get personalized suggestions on what to learn next</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-text-main">Guided projects</p>
                      <p className="text-xs text-text-muted">Build portfolio-worthy projects with step-by-step guides</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-bg-elevated rounded-lg p-4 mb-6">
                  <div className="grid grid-cols-2 gap-4 text-center">
                    <div>
                      <div className="text-lg font-bold text-primary">${career?.avgSalaryUSD?.toLocaleString() || 'N/A'}</div>
                      <div className="text-xs text-text-muted">Avg. Salary</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold text-secondary">{career?.growthRate || 'High'}</div>
          ...
          {step === 2 && (
            <>
              <div className="p-6 border-b border-border">
                <div className="flex items-center justify-between">
                  <div>
                    <h2 className="text-xl font-bold text-text-main">Customize Your Journey</h2>
                    <p className="text-sm text-text-muted">Help us create the perfect roadmap for you</p>
                  </div>
                  <button 
                    onClick={handleClose}
                    className="w-8 h-8 rounded-lg bg-bg-elevated flex items-center justify-center text-text-muted hover:text-text-main transition-colors"
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {weeklyHoursOptions.map(option => (
                      <button
                        key={option.value}
                        onClick={() => setPreferences(p => ({ ...p, weeklyHours: option.value }))}
                        className={`
                        ...
                        `}
                      >
                        <div className={`font-bold ${preferences.weeklyHours === option.value ? 'text-primary' : 'text-text-main'}`}>
                          {option.label}
                        </div>
                ...
                <div>
                  ...
                  <div className="space-y-2">
                    {experienceLevels.map(level => (
                      <button
                        key={level.value}
                        onClick={() => setPreferences(p => ({ ...p, experienceLevel: level.value }))}
                        className={`
                      ...
                      >
                        <div>
                          <div className={`font-medium ${preferences.experienceLevel === level.value ? 'text-secondary' : 'text-text-main'}`}>
                            {level.label}
                          </div>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {learningStyles.map(style => (
                      <button
                        key={style.value}
                        onClick={() => setPreferences(p => ({ ...p, learningStyle: style.value }))}
                        className={`
                      ...
                      >
                        ...
                        <div className={`text-sm font-medium ${preferences.learningStyle === style.value ? 'text-accent' : 'text-text-main'}`}>
                          {style.label}
                        </div>
                      </button>
                    ))}
          ...
          {step === 3 && (
            <div className="p-12 text-center">
              ...
              <h2 className="text-xl font-bold text-text-main mb-2">Generating Your Roadmap</h2>
          ...
          {step === 4 && (
            <div className="p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-text-main mb-2">Journey Started! 🎉</h2>
