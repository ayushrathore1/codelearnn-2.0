...
import { faLock, faGem, faRocket } from '@fortawesome/free-solid-svg-icons';
import { Link } from 'react-router-dom';

const LockedContent = ({ children, isLocked = false, title = "Premium Content", blurAmount = "blur-md" }) => {
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-6 text-center bg-gradient-to-b from-transparent via-bg-base/80 to-bg-base">
        ...
        >
          ...
          <p className="text-sm text-text-muted mb-6">
            Unlock this advanced module to access premium resources, source code, and expert insights.
          </p>
          ...
          <p className="mt-4 text-xs text-text-dim">
            Already a member? <Link to="/login" className="text-primary hover:text-secondary underline">Sign in</Link>
          </p>
        </motion.div>
      </div>
    </div>
